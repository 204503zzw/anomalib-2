...
- 🚀 **pipelines**: Add a `runs` section to the benchmark config to queue an explicit list of named parameter sets instead of a grid search, each saving its results to `<output_dir>/<name>/results.csv`
